# <a name="main-heading"></a>Graphics Test Coding Style & Licensing

If you make any contributions to Graphics Test, you are agreeing that any code you have contributed will be licensed under the GNU GPL version 3.
...
This guide is for developers who wish to contribute to the Graphics Test codebase. It will detail how to properly style and format code to fit this project. This guide also offers suggestions on specific functions and other varia that may be used in code.
...
- When declaring includes in a source file, make sure they follow the given pattern:
  ...
  - Other Graphics Test source file headers
- Each of the above header sections should also be in alphabetical order
- Project source file headers should be included in a way that is relative to the `[Graphics Test Root]/Source/Core` directory.
